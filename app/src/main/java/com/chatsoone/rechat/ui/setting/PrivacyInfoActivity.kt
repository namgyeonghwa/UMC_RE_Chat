...
class PrivacyInfoActivity :
    BaseActivity<ActivityPrivacyInformationBinding>(ActivityPrivacyInformationBinding::inflate) {
    ...
    private fun initPrivacyInformation() {
        ...
        privacyInformationList =
            database.privacyInformationDao().getPrivacyInformation() as ArrayList
